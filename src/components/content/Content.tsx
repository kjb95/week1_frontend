...
import DisableNotificationCard from "./card/DisableNotificationCard";
import EnableNotificationCard from "./card/EnableNotificationCard";
      ...
      <div className="inner-content">
        ...
        <div className="content-body">
          <div className="container-fluid">
            ...
            <div className="row flex-container">
              <DisableNotificationCard />
              <RegisterAccountCard />
            </div>
          </div>

          <script>
            $('#pageTitle').text("설정"); $('#contentHeaderTitle').text("설정");
          </script>
