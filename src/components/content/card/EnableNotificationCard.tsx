  ...
  return (
    <div className="col col-6">
      <div className="wrap-section wrap-tbl">
        <CardTitle data="알림설정" />
        <CardCheckbox data="알림 수신동의" isChecked={true} />
        <CardBusinessNumber
          title="충전사업자번호"
          contents={[
            { data: "캠페인 알림 수신", isChecked: true },
            { data: "프로모션 알림 수신", isChecked: true },
            { data: "비즈머니 충전 알림 수신", isChecked: true },
            { data: "야간 알림 수신 (21시 ~ 익일 8시)" },
          ]}
