		...
		<div className="col col-6">
			<div className="wrap-section wrap-tbl">
				...
				<CardBusinessNumber
					title="충전사업자번호"
					contents={[
						{ data: "캠페인 알림 수신", isDisabled: true, checkboxId: "inp-check-05" },
						{ data: "프로모션 알림 수신", isDisabled: true, checkboxId: "inp-check-06" },
						{ data: "비즈머니 충전 알림 수신", isDisabled: true, checkboxId: "inp-check-07" },
						{ data: "야간 알림 수신 (21시 ~ 익일 8시)", isDisabled: true, checkboxId: "inp-check-08" },
					]}
