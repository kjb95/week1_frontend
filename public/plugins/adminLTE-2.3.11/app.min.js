	...
	($.AdminLTE.layout = {
		...
		fix: function () {
			...
			var a = $(".main-footer").outerHeight() || 0,
				...
				c = $(window).height(),
				d = $(".sidebar").height() || 0;
			if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", c - a);
			else {
				var e;
				c >= d
					? ($(".content-wrapper, .right-side").css("min-height", c - b), (e = c - b))
					: ($(".content-wrapper, .right-side").css("min-height", d), (e = d));
		...
		($.AdminLTE.pushMenu = {
			activate: function (a) {
				...
				$(document).on("click", a, function (a) {
					...
					($.AdminLTE.options.sidebarExpandOnHover || ($("body").hasClass("fixed") && $("body").hasClass("sidebar-mini"))) &&
						this.expandOnHover();
			},
...
($.AdminLTE = {}),
	($.AdminLTE.options = {
		...
		enableBoxRefresh: !0,
		enableBSToppltip: !0,
		/*BSTooltipSelector:"[data-toggle='tooltip']",*/ enableFastclick: !1,
	...
	$(function () {
		...
		_init(),
			...
			a.navbarMenuSlimscroll &&
				"undefined" != typeof $.fn.slimscroll &&
				$(".navbar .menu")
					.slimscroll({ height: a.navbarMenuHeight, alwaysVisible: !1, size: a.navbarMenuSlimscrollWidth })
					.css("width", "100%"),
			a.sidebarPushMenu && $.AdminLTE.pushMenu.activate(a.sidebarToggleSelector),
			a.enableBSToppltip /*&&$("body").tooltip({selector:a.BSTooltipSelector,container:"body"})*/,
